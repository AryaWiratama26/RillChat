...
public class AIChatActivity extends BaseActivity {
    ...
    private void init() {
        ...
        chatAdapter = new ChatAdapter(chatMessages, null, preferenceManager.getString(Constants.KEY_USER_ID), this);
    ...
    private void getAIResponse(String userMessage) {
        ...
        String systemPrompt = "Saya adalah asisten AI yang mampu membantu menjawab pertanyaan seputar Universitas Pelita Bangsa (UPB)... Jangan jawab pertanyaan diluar Konteks UPB, jika ada yang bertanya jawab dengan Anda Keluar Dari Topik Pertanyaan Nih, Aku hanya bisa Bantu kamu seputar UPB aja :D" +
                "# PROFIL\n" +
                ...
                "- Keuangan: +62 851-5640-9450";  // [Potong untuk ringkas]
    ...
    private void displayBotMessage(String message) {
        try {
            ...
            // Ambil ID user dengan aman dari PreferenceManager
            String userId = preferenceManager.getString(Constants.KEY_USER_ID);
            if (userId == null || userId.isEmpty()) {
                Log.e("AIChat", "User ID is null or empty in displayBotMessage()");
                return; // Keluar supaya tidak crash
            }
            ...
            Log.e("AIChat", "displayBotMessage error: ", e);
        }
    }
